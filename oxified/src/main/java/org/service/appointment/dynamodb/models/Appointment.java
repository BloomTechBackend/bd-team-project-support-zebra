...
public class Appointment {
    ...
    public boolean equals(Object o) {
        ...
        return appointmentId.equals(that.appointmentId) && date.equals(that.date) &&
                time.equals(that.time) && serviceId.equals(that.serviceId) &&
                addressId.equals(that.addressId) && status.equals(that.status);
    }
